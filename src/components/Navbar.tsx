...
import { Code, ChevronDown, ChevronRight, Home, TestTube, BookOpen } from 'lucide-react'
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a 
              ...
              className="flex items-center gap-1 px-2 py-1 text-xs text-gray-600 hover:text-orange-600 hover:bg-orange-50 rounded-md transition-all"
            >
